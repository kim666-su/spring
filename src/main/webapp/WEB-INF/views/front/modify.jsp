...
<div class="row">
  <div class="col-lg-12">
    <h1 class="page-header">FBoard Modify</h1>
  </div>
  <!-- /.col-lg-12 -->
</div>
<!-- /.row -->
...
<div class="row">
  <div class="col-lg-12">
    <div class="panel panel-default">
      ...
      <div class="panel-heading">FBoard Modify</div>
      <!-- /.panel-heading -->
...
<div class="form-group">
  ...
  <input class="form-control" name='title' 
    value='<c:out value="${tbl_free_board.title }"/>' >
</div>

<div class="form-group">
  <label>Text area</label>
  <textarea class="form-control" rows="3" name='content' ><c:out value="${tbl_free_board.content}"/></textarea>
</div>

<div class="form-group">
  <label>Writer</label> 
  <input class="form-control" name='writer'
    value='<c:out value="${tbl_free_board.nick}"/>' readonly="readonly">            
</div>
...
<c:forEach var="i" begin="1" end="3">
   ...
   <sec:authorize access="isAuthenticated()">
      <c:if test="${pinfo.username eq tbl_free_board.nick}">
